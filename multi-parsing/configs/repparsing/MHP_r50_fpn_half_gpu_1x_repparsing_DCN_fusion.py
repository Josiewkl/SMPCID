...
# optimizer
lr_base = 0.000625
optimizer = dict(type='SGD', lr=(lr_base*data['samples_per_gpu'] * 2), momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs/MHP_release_r50_fpn_8gpu_1x_repparsing_v0_DCN_fusion/'
load_from = None
resume_from = None
workflow = [('train', 1)]
